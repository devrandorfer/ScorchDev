...
Function Publish-AzureAutomationDSCChange
{
    ...
    Try
    {
        ...
        {
            $UpdateCompleteParams = Write-StartingMessage -CommandName 'Updating DSC Configuration' -String "[$($DSCInformation | ConvertTo-Json -Depth 5)]"
        ...
        {
            Write-Verbose -Message "DSC Configuration is not a new version. Skipping. [$($DSCInformation | ConvertTo-Json -Depth 5)]"
        }
    }
    Catch
    {
...
Function Sync-IndividualGitRepositoryToAzureAutomation
{
    ...
    Try
    {
        ...
        if(-not ($RepositoryChange.CurrentCommit -as [string]).Equals($CurrentCommit -as [string]))
        {
            ...
            Write-Verbose -Message "Finished Processing [$($CurrentCommit)..$($RepositoryChange.CurrentCommit)]"
        }
    }
    Catch
    {
